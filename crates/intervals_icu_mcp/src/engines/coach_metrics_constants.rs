...
pub const STRYD_POWER_CORRECTION: f64 = 0.92;
pub const GARMIN_RP_POWER_CORRECTION: f64 = 1.08;
pub const GAP_POWER_COEFFICIENT: f64 = 0.25;
pub const GAP_UPHILL_GRADIENT_FACTOR: f64 = 0.08;
pub const GAP_DOWNHILL_GRADIENT_FACTOR: f64 = 0.02;
...
pub const GAP_SPEED_EXPONENT: i32 = 3;
